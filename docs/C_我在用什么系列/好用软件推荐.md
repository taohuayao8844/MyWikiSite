...
对于不会使用git工具的你，使用githubdesktop无疑是最方便的代码管理方案，建议配套使用汉化包插件。[Github Desktop 汉化工具 ](https://github.com/robotze/GithubDesktopZhTool)如果不知道什么是`git`，那么你可能需要这篇文章，[【git操作】](../B_软件学习篇/一定要学的工具链/git操作.md)
