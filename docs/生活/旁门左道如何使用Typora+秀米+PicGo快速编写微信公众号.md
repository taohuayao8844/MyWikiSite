...
![68ee41ce75fa9](/image_photo/typora/68ee41ce75fa9.png)
...
![68ee41ea344f6](/image_photo/typora/68ee41ea344f6.png)

#### ▶ 必学操作：

- 写标题：输入 `# 一级标题`，`## 二级标题`，最多到六级
- 插图片：直接拖图片进 <span class="font-bold">Typora</span>，后面会自动上传到云端
...
3. **打造个人风格**：比如把引用区块改成浅蓝底色，文末分割线换成波浪线，让读者一眼认出你的文章
   ...
   ![68ee4202aeb9b](/image_photo/typora/68ee4202aeb9b.png)
...
3. **关键步骤！** 仓库权限一定要选「开源」（不然图片别人看不到）
   ...
   ![68ee42610fc73](/image_photo/typora/68ee42610fc73.png)

4. 记住仓库路径，格式是 `你的用户名/仓库名`（比如 `xiaoming/wechat-pics`）

   ![68ee42a75a02e](/image_photo/typora/68ee42a75a02e.png)

### ▶ 第二步：生成访问令牌（重要！别泄露）

1. 点头像进「设置」→「私人令牌」→「生成新令牌」

   ![68ee42831e0b0](/image_photo/typora/68ee42831e0b0.png)
...
1. 下载安装 PicGo（搜「PicGo 官网」就行）
   ...
   ![68ee4291b4cf5](/image_photo/typora/68ee4291b4cf5.png)
...
4. 点「设为默认图床」，然后点「上传区」拖张图测试，成功的话 Gitee 仓库里会出现图片
   ...
   ![68ee41c2094b7](/image_photo/typora/68ee41c2094b7.png)
...
4. 点「验证图片上传」，提示成功就 OK 啦～
   ...
   ![68ee42caa8911](/image_photo/typora/68ee42caa8911.png)
...
​	![68ee42d5a46f5](/image_photo/typora/68ee42d5a46f5.png)

### ▶ 2. 秀米里美化排版（5 分钟变精致）

1. 在 Typora 全选复制文章，粘贴到秀米编辑器

   ![68ee42c0b498e](/image_photo/typora/68ee42c0b498e.png)
...
![68ee455492dd9](/image_photo/typora/68ee455492dd9.png)
...
4. 与两边的间距不对，改图片显示的参数就好了，左右边距，很快速的就写好一篇推送了！
   ...
   ![68ee4573ad8e9](/image_photo/typora/68ee4573ad8e9.png)
